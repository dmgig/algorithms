...
def fibonacci_sum_last_digit_again_stress_test():
    while 1:
        n = random.randint(0,10**18)
        m = random.randint(0,n)
        print("FINAL: %i %i %i" % (m, n, fibonacci_sum_last_digit_again(m, n)))

fibonacci_sum_last_digit_again_stress_test()
